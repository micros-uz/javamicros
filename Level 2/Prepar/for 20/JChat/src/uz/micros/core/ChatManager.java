    ...
    private void startSearch() {
        try {
            ...
            for (int k = 140; k <= 150; k++) {
                ...
                if (!ia.getHostAddress().equals(InetAddress.getLocalHost().getHostAddress()))
                    new Broadcaster(this).send(hostUserName, ia, serverPort);
            }
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Client client = new Client(socket, cm, true);
                        client.run();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
